export const en = {
  ...
  phone: {
    ...
    ongoing: 'Ongoing',
    upcoming: 'Upcoming',
    trip1City: 'Mexico City',
    trip1Meta: 'Mexico · 12 Feb – 20 Feb',
    flightTitle: 'Madrid → Mexico City',
    flightMeta: 'Flight · Iberia',
    flightDate: '12 Feb',
    hotelTitle: 'Tulum',
    hotelMeta: 'Stay · Hostel Oryx Tulum',
    hotelDate: '12 – 19 Feb',
    insuranceTitle: 'Travel Insurance',
    insuranceMeta: 'Insurance · AXA',
    insuranceDate: '12 – 20 Feb',
    trip1Docs: '4 documents',
    seeAll: 'See all',
    trip2City: 'Lisbon',
    trip2Meta: 'Portugal · 03 Mar – 09 Mar',
    trip2Docs: '2 documents',
    tabTrips: 'Trips',
  ...
  invite: {
    ...
    codeHint: 'Write it down before you install. Doku asks for it the first time you open the app, under “Join a trip”.',
    codeCopy: 'Copy code',
    codeCopied: 'Copied',
